...
This is an investment-discipline workflow skill for Codex and other common AI agents. It turns scattered trade ideas, holdings screenshots, and review notes into a repeatable operating system:
...
这是一个面向Claude, Codex, Antigravity, Cursor, Openclaw和其他常见AI Agent的“投资纪律工作流” skill。它把零散的交易想法、持仓截图、复盘笔记，整理成一套可重复执行的操作系统：
